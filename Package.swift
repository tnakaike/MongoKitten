...
var package = Package(
    ...
    dependencies: [
        ...
        .Package(url: "https://github.com/tnakaike/BSON.git", versions: Version(5, 2, 4) ..< Version(6, 0, 0)),
        
        // For ExtendedJSON support
        .Package(url: "https://github.com/OpenKitten/Cheetah.git", majorVersion: 2),

        // Authentication
        .Package(url: "https://github.com/tnakaike/CryptoKitten.git", majorVersion: 0, minor: 2),
